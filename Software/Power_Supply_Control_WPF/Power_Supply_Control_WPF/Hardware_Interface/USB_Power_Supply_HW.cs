...
{
    public class USB_Power_Supply_HW
    {
        ...
        {
            if(_usbAdapter == null || COM_PORT == null) return false;

            return await _usbAdapter.ConnectToDevice(COM_PORT);
        }

        public async Task Disconnect()
        {
            if (_usbAdapter == null) return;
